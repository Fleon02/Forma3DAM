...
package PlantillasUI.Popups;

import PlantillasUI.Eventos.EventoMenuSeleccionado;
import PlantillasUI.MenuButton;
...
public class PopupMenu extends javax.swing.JDialog {
    ...
    public PopupMenu(java.awt.Frame parent, int index, EventoMenuSeleccionado eventoSeleccionado, String... subMenu) {
        super(parent, false);
        initComponents();
        setOpacity(0f);
    ...
    private void initComponents() {
        ...
        panel = new PlantillasUI.Popups.PanelPopup();
    ...
    private PlantillasUI.Popups.PanelPopup panel;
