...
public class AlumnosDAO {
    ...
    public void actualizaAlumnos(String idAlumno, String dniAlumno, String nombreAlumno, String yearCurso, String segSocialAlumno, int validez, String cicloAlumno, byte[] cv) {
        try {
            iniciaOperacion();
