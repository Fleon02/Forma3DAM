...
public class VntConfiguracion extends javax.swing.JPanel {
    ...
    public VntConfiguracion(JFrame vntPrincipal) {
        initComponents();
        frame = vntPrincipal;
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        if (txtIDUsuario.getText() != "" && txtNombreUsuario.getText() != "" && txtCorreoUsuario.getText() != "" && cmbRol.getSelectedIndex() != 0) {
