...
public class VntAlumnos extends javax.swing.JPanel {
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        if (txtDNIAlumno.getText() != "") {
            new AlumnosDAO().eliminaAlumnos(txtIDAlumno.getText());
            cargaTabla();
        } else {
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        if (txtDNIAlumno.getText() != "" && txtNombreAlumno.getText() != "" && txtAnioAlumno.getText() != ""
            ...
            if (checkbValidez.isSelected()) {
                new AlumnosDAO().actualizaAlumnos(txtIDAlumno.getText(), txtDNIAlumno.getText(), txtNombreAlumno.getText(), txtAnioAlumno.getText(),
