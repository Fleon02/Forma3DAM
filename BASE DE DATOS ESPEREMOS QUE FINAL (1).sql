...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-02-2024 a las 04:39:24
...
INSERT INTO `convenio` (`idConvenio`, `idEmpresa`, `numConvenio`, `nombreEmpresa`, `responsableFirma`, `cantAnexos`, `anexoUnoConvenio`) VALUES
(7, 2, 11111, 'Empresa 2', 'Paco', 4, NULL);
...
ALTER TABLE `bolsa`
  ...
  ADD KEY `fk_bolsa_anexos` (`idAnexo`),
...
--
ALTER TABLE `anexos`
  MODIFY `idAnexo` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
ALTER TABLE `bolsa`
  ...
  ADD CONSTRAINT `fk_bolsa_anexos` FOREIGN KEY (`idAnexo`) REFERENCES `anexos` (`idAnexo`);
